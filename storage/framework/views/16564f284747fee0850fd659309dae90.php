<?php $__env->startSection('title', 'Tanahku.id | Platform Jual Beli Tanah Digital'); ?>
                        ...
                        <div class="col-md-4">
                            <div class="card shadow-sm h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-muted"><?php echo e(Str::limit($item->description, 80)); ?></p>
                                    <a href="<?php echo e(route('map', ['focus_polygon' => $item->id])); ?>"
                        ...
                        <div class="col-md-4">
                            <div class="card shadow-sm h-100">
                                ...
                                <div class="card-body">
                                    <h5><?php echo e($item->name); ?></h5>
                                    <p class="text-muted"><?php echo e(Str::limit($item->description, 80)); ?></p>
                                    <a href="<?php echo e(route('map', ['focus_point' => $item->id])); ?>"
                                        class="btn btn-outline-primary btn-sm">Lihat Detail</a>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PGWL_NAFIS\pgwl\resources\views/landing/index.blade.php ENDPATH**/ ?>
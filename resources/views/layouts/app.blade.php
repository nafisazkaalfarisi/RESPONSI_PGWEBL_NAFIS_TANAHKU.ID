...
<head>
    ...
    <title>@yield('title', config('app.name', 'Tanahku.id'))</title>

    <link rel="icon" href="{{ asset('images/tanahku.png') }}" type="image/png">
...
<body class="{{ session('theme', 'light') === 'dark' ? 'bg-dark text-light' : '' }}">

    {{-- Sidebar --}}
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header d-flex align-items-center justify-content-center">
    <img src="{{ asset('images/tanahku.png') }}" alt="Tanahku.id Logo"
    ...
    <span class="logo-text">Tanahku.id</span>
        ...
        <ul class="nav flex-column mt-3">
            ...
            <li class="{{ request()->routeIs('home') ? 'active' : '' }}" onclick="location.href='{{ route('home') }}'">
                <i class="fas fa-home"></i> <span>Home</span>
            </li>
            <li class="{{ request()->routeIs('map') ? 'active' : '' }}" onclick="location.href='{{ route('map') }}'">
                <i class="fas fa-map-marked-alt"></i> <span>Peta</span>
            </li>
            <li class="{{ request()->routeIs('table') ? 'active' : '' }}"
                onclick="location.href='{{ route('table') }}'">
            ...
            @auth
                ...
                <li class="{{ request()->routeIs('help') ? 'active' : '' }}"
                    onclick="location.href='{{ route('help') }}'">

        ...
        <div id="heroCarousel" class="carousel slide carousel-fade mb-5" data-bs-ride="carousel" data-bs-interval="5000">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="hero-text">
                        <img src="{{ asset('images/tanahku100.png') }}" alt="Logo Tanahku"
                ...
                <div class="carousel-item">
                    ...
                    <div class="hero-overlay"></div>
                    <div class="hero-text">
                        <img src="{{ asset('images/tanahku100.png') }}" alt="Logo Tanahku" style="height: 80px; object-fit: contain; max-width: 80px;" class="mb-3">
